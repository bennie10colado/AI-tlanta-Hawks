...
def fetch_player_game_logs(season="2024-25"):
    ...
    try:
        ...
        for name, player_id in player_ids.items():
            try:
                ...
                for game in games:
                    ...
                    game_logs.append([name, game_date, opponent, win_loss, home_away, points, rebounds, assists, fg3_attempted, fg3_made, minutes_played])
        ...
        df = pd.DataFrame(game_logs, columns=["Jogador", "Data do Jogo", "Adversário", "Vitória/Derrota", "Casa/Fora", "Pontos", "Rebotes",
                                              "Assistências", "Tentativas de 3 PTS", "Cestas de 3 PTS", "Tempo de Permanência do Jogador em Quadra"])
